...
export const skillsByCategory: Record<string, SkillEntry[]> = {
  languages: [
    ...
    { name: 'PHP', icon: 'devicon-php-plain colored', level: 3 },
  ],
  frontend: [
    { name: 'React', icon: 'devicon-react-original colored', level: 2 },
    { name: 'Angular', icon: 'devicon-angularjs-plain colored', level: 4 },
    { name: 'HTML', icon: 'devicon-html5-plain colored', level: 5 },
    { name: 'CSS', icon: 'devicon-css3-plain colored', level: 4 },
    { name: 'Bootstrap', icon: 'devicon-bootstrap-plain colored', level: 4 },
    { name: 'SweetAlert2', icon: '', level: 4 },
  ],
  backend: [
    { name: 'Node.js', icon: 'devicon-nodejs-plain colored', level: 2 },
    { name: 'Express', icon: 'devicon-express-original colored', level: 2 },
    { name: 'NestJS', icon: 'devicon-nestjs-plain colored', level: 1 },
    { name: 'Django', icon: 'devicon-django-plain colored', level: 1 },
    { name: 'Flask', icon: 'devicon-flask-original colored', level: 3 },
    { name: 'FastAPI', icon: 'devicon-fastapi-plain colored', level: 3 },
    { name: 'Laravel', icon: 'devicon-laravel-plain colored', level: 4 },
  ],
  databases: [
    { name: 'MySQL', icon: 'devicon-mysql-plain colored', level: 5 },
    { name: 'MariaDB', icon: 'devicon-mariadb-plain colored', level: 5 },
    { name: 'MongoDB', icon: 'devicon-mongodb-plain colored', level: 3 },
    { name: 'SQLite', icon: 'devicon-sqlite-plain colored', level: 5 },
    { name: 'SQL Server', icon: 'devicon-microsoftsqlserver-plain colored', level: 5 },
  ],
  cloud: [
  ...
  'data science': [
    ...
    { name: 'Matplotlib', icon: 'devicon-matplotlib-plain colored', level: 1 },
    { name: 'Seaborn', icon: '', level: 1 },
    { name: 'Scikit-learn', icon: 'devicon-scikitlearn-plain colored', level: 1 },
    { name: 'TensorFlow', icon: 'devicon-tensorflow-original colored', level: 2 },
    { name: 'PyTorch', icon: 'devicon-pytorch-plain colored', level: 1 },
    { name: 'Keras', icon: 'devicon-keras-plain colored', level: 1 },
    { name: 'SciPy', icon: '', level: 2 },
    { name: 'Statsmodels', icon: '', level: 1 },
    { name: 'Jupyter', icon: 'devicon-jupyter-plain colored', level: 4 },
    { name: 'Google Colab', icon: '', level: 4 },
    { name: 'Pentaho', icon: '', level: 5 },
    { name: 'ETL', icon: '', level: 5 },
  ],
  tools: [
    ...
    { name: 'Power BI', icon: '', level: 4 },
    { name: 'Power Automate', icon: '', level: 3 },
    { name: 'Bruno', icon: '', level: 3 },
    { name: 'Excel', icon: '', level: 5 },
    { name: 'REST API', icon: '', level: 4 },
    { name: 'JWT', icon: '', level: 4 },
